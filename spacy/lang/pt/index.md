Module spacy.lang.pt
====================

Sub-modules
-----------
* spacy.lang.pt.examples
* spacy.lang.pt.lex_attrs
* spacy.lang.pt.punctuation
* spacy.lang.pt.stop_words
* spacy.lang.pt.syntax_iterators
* spacy.lang.pt.tokenizer_exceptions

Classes
-------

`Portuguese(vocab: Union[spacy.vocab.Vocab, bool] = True, *, max_length: int = 1000000, meta: Dict[str, Any] = {}, create_tokenizer: Optional[Callable[[ForwardRef('Language')], Callable[[str], spacy.tokens.doc.Doc]]] = None, batch_size: int = 1000, **kwargs)`
