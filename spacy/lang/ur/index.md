Module spacy.lang.ur
====================

Sub-modules
-----------
* spacy.lang.ur.examples
* spacy.lang.ur.lex_attrs
* spacy.lang.ur.punctuation
* spacy.lang.ur.stop_words

Classes
-------

`Urdu(vocab: Union[spacy.vocab.Vocab, bool] = True, *, max_length: int = 1000000, meta: Dict[str, Any] = {}, create_tokenizer: Optional[Callable[[ForwardRef('Language')], Callable[[str], spacy.tokens.doc.Doc]]] = None, batch_size: int = 1000, **kwargs)`
