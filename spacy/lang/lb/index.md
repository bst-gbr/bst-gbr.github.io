Module spacy.lang.lb
====================

Sub-modules
-----------
* spacy.lang.lb.examples
* spacy.lang.lb.lex_attrs
* spacy.lang.lb.punctuation
* spacy.lang.lb.stop_words
* spacy.lang.lb.tokenizer_exceptions

Classes
-------

`Luxembourgish(vocab: Union[spacy.vocab.Vocab, bool] = True, *, max_length: int = 1000000, meta: Dict[str, Any] = {}, create_tokenizer: Optional[Callable[[ForwardRef('Language')], Callable[[str], spacy.tokens.doc.Doc]]] = None, batch_size: int = 1000, **kwargs)`
