Module spacy.lang.da
====================

Sub-modules
-----------
* spacy.lang.da.examples
* spacy.lang.da.lex_attrs
* spacy.lang.da.punctuation
* spacy.lang.da.stop_words
* spacy.lang.da.syntax_iterators
* spacy.lang.da.tokenizer_exceptions

Classes
-------

`Danish(vocab: Union[spacy.vocab.Vocab, bool] = True, *, max_length: int = 1000000, meta: Dict[str, Any] = {}, create_tokenizer: Optional[Callable[[ForwardRef('Language')], Callable[[str], spacy.tokens.doc.Doc]]] = None, batch_size: int = 1000, **kwargs)`
