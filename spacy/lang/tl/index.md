Module spacy.lang.tl
====================

Sub-modules
-----------
* spacy.lang.tl.lex_attrs
* spacy.lang.tl.stop_words
* spacy.lang.tl.tokenizer_exceptions

Classes
-------

`Tagalog(vocab: Union[spacy.vocab.Vocab, bool] = True, *, max_length: int = 1000000, meta: Dict[str, Any] = {}, create_tokenizer: Optional[Callable[[ForwardRef('Language')], Callable[[str], spacy.tokens.doc.Doc]]] = None, batch_size: int = 1000, **kwargs)`
