Module spacy.lang.nl
====================

Sub-modules
-----------
* spacy.lang.nl.examples
* spacy.lang.nl.lemmatizer
* spacy.lang.nl.lex_attrs
* spacy.lang.nl.punctuation
* spacy.lang.nl.stop_words
* spacy.lang.nl.syntax_iterators
* spacy.lang.nl.tokenizer_exceptions

Classes
-------

`Dutch(vocab: Union[spacy.vocab.Vocab, bool] = True, *, max_length: int = 1000000, meta: Dict[str, Any] = {}, create_tokenizer: Optional[Callable[[ForwardRef('Language')], Callable[[str], spacy.tokens.doc.Doc]]] = None, batch_size: int = 1000, **kwargs)`
