Module spacy.lang.te
====================

Sub-modules
-----------
* spacy.lang.te.examples
* spacy.lang.te.lex_attrs
* spacy.lang.te.stop_words

Classes
-------

`Telugu(vocab: Union[spacy.vocab.Vocab, bool] = True, *, max_length: int = 1000000, meta: Dict[str, Any] = {}, create_tokenizer: Optional[Callable[[ForwardRef('Language')], Callable[[str], spacy.tokens.doc.Doc]]] = None, batch_size: int = 1000, **kwargs)`
