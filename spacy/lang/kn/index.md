Module spacy.lang.kn
====================

Sub-modules
-----------
* spacy.lang.kn.examples
* spacy.lang.kn.stop_words

Classes
-------

`Kannada(vocab: Union[spacy.vocab.Vocab, bool] = True, *, max_length: int = 1000000, meta: Dict[str, Any] = {}, create_tokenizer: Optional[Callable[[ForwardRef('Language')], Callable[[str], spacy.tokens.doc.Doc]]] = None, batch_size: int = 1000, **kwargs)`
