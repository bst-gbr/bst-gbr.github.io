Module spacy.lang.de
====================

Sub-modules
-----------
* spacy.lang.de.examples
* spacy.lang.de.punctuation
* spacy.lang.de.stop_words
* spacy.lang.de.syntax_iterators
* spacy.lang.de.tokenizer_exceptions

Classes
-------

`German(vocab: Union[spacy.vocab.Vocab, bool] = True, *, max_length: int = 1000000, meta: Dict[str, Any] = {}, create_tokenizer: Optional[Callable[[ForwardRef('Language')], Callable[[str], spacy.tokens.doc.Doc]]] = None, batch_size: int = 1000, **kwargs)`
