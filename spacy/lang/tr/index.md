Module spacy.lang.tr
====================

Sub-modules
-----------
* spacy.lang.tr.examples
* spacy.lang.tr.lex_attrs
* spacy.lang.tr.stop_words
* spacy.lang.tr.syntax_iterators
* spacy.lang.tr.tokenizer_exceptions

Classes
-------

`Turkish(vocab: Union[spacy.vocab.Vocab, bool] = True, *, max_length: int = 1000000, meta: Dict[str, Any] = {}, create_tokenizer: Optional[Callable[[ForwardRef('Language')], Callable[[str], spacy.tokens.doc.Doc]]] = None, batch_size: int = 1000, **kwargs)`
