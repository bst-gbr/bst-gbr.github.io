Module spacy.lang.ga.lemmatizer
===============================
...
`demutate(word: str, is_hpref: bool = False) ‑> str`
:   
...
`IrishLemmatizer(vocab: spacy.vocab.Vocab, model: Optional[thinc.model.Model], name: str = 'lemmatizer', *, mode: str = 'lookup', overwrite: bool = False, scorer: Optional[Callable] = <function lemmatizer_score>)`
