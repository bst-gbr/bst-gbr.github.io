Module spacy.lang.vi
====================

Sub-modules
-----------
* spacy.lang.vi.examples
* spacy.lang.vi.lex_attrs
* spacy.lang.vi.stop_words

Classes
-------

`Vietnamese(vocab: Union[spacy.vocab.Vocab, bool] = True, *, max_length: int = 1000000, meta: Dict[str, Any] = {}, create_tokenizer: Optional[Callable[[ForwardRef('Language')], Callable[[str], spacy.tokens.doc.Doc]]] = None, batch_size: int = 1000, **kwargs)`
