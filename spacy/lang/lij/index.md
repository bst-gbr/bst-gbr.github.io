Module spacy.lang.lij
=====================

Sub-modules
-----------
* spacy.lang.lij.examples
* spacy.lang.lij.punctuation
* spacy.lang.lij.stop_words
* spacy.lang.lij.tokenizer_exceptions

Classes
-------

`Ligurian(vocab: Union[spacy.vocab.Vocab, bool] = True, *, max_length: int = 1000000, meta: Dict[str, Any] = {}, create_tokenizer: Optional[Callable[[ForwardRef('Language')], Callable[[str], spacy.tokens.doc.Doc]]] = None, batch_size: int = 1000, **kwargs)`
