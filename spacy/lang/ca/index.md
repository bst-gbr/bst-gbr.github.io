Module spacy.lang.ca
====================

Sub-modules
-----------
* spacy.lang.ca.examples
* spacy.lang.ca.lemmatizer
* spacy.lang.ca.lex_attrs
* spacy.lang.ca.punctuation
* spacy.lang.ca.stop_words
* spacy.lang.ca.syntax_iterators
* spacy.lang.ca.tokenizer_exceptions

Classes
-------

`Catalan(vocab: Union[spacy.vocab.Vocab, bool] = True, *, max_length: int = 1000000, meta: Dict[str, Any] = {}, create_tokenizer: Optional[Callable[[ForwardRef('Language')], Callable[[str], spacy.tokens.doc.Doc]]] = None, batch_size: int = 1000, **kwargs)`
