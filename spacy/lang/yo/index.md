Module spacy.lang.yo
====================

Sub-modules
-----------
* spacy.lang.yo.examples
* spacy.lang.yo.lex_attrs
* spacy.lang.yo.stop_words

Classes
-------

`Yoruba(vocab: Union[spacy.vocab.Vocab, bool] = True, *, max_length: int = 1000000, meta: Dict[str, Any] = {}, create_tokenizer: Optional[Callable[[ForwardRef('Language')], Callable[[str], spacy.tokens.doc.Doc]]] = None, batch_size: int = 1000, **kwargs)`
