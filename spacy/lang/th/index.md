Module spacy.lang.th
====================

Sub-modules
-----------
* spacy.lang.th.lex_attrs
* spacy.lang.th.stop_words
* spacy.lang.th.tokenizer_exceptions

Classes
-------

`Thai(vocab: Union[spacy.vocab.Vocab, bool] = True, *, max_length: int = 1000000, meta: Dict[str, Any] = {}, create_tokenizer: Optional[Callable[[ForwardRef('Language')], Callable[[str], spacy.tokens.doc.Doc]]] = None, batch_size: int = 1000, **kwargs)`
