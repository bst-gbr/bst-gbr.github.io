Module spacy.lang.fi
====================

Sub-modules
-----------
* spacy.lang.fi.examples
* spacy.lang.fi.lex_attrs
* spacy.lang.fi.punctuation
* spacy.lang.fi.stop_words
* spacy.lang.fi.tokenizer_exceptions

Classes
-------

`Finnish(vocab: Union[spacy.vocab.Vocab, bool] = True, *, max_length: int = 1000000, meta: Dict[str, Any] = {}, create_tokenizer: Optional[Callable[[ForwardRef('Language')], Callable[[str], spacy.tokens.doc.Doc]]] = None, batch_size: int = 1000, **kwargs)`
