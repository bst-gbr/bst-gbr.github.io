Module spacy.lang.hy
====================

Sub-modules
-----------
* spacy.lang.hy.examples
* spacy.lang.hy.lex_attrs
* spacy.lang.hy.stop_words

Classes
-------

`Armenian(vocab: Union[spacy.vocab.Vocab, bool] = True, *, max_length: int = 1000000, meta: Dict[str, Any] = {}, create_tokenizer: Optional[Callable[[ForwardRef('Language')], Callable[[str], spacy.tokens.doc.Doc]]] = None, batch_size: int = 1000, **kwargs)`
