Module spacy.lang.grc
=====================

Sub-modules
-----------
* spacy.lang.grc.examples
* spacy.lang.grc.lex_attrs
* spacy.lang.grc.stop_words
* spacy.lang.grc.tokenizer_exceptions

Classes
-------

`AncientGreek(vocab: Union[spacy.vocab.Vocab, bool] = True, *, max_length: int = 1000000, meta: Dict[str, Any] = {}, create_tokenizer: Optional[Callable[[ForwardRef('Language')], Callable[[str], spacy.tokens.doc.Doc]]] = None, batch_size: int = 1000, **kwargs)`
